...
class _Node with _NodeImpl implements Node {
...
class _Element with _ElementImpl, _NodeImpl implements Element {
...
class _HtmlProviderBrowser implements HtmlProvider {
  @override
